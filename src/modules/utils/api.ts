...
export class ApiService {
    ...
    async createSubscription(apiKey: string, amount: number, validAfter: Date, validUntil: Date, initiatorAddress: String, subscriberAddress: String, paymentInterval: number, paymentLimit : number, dappId: string) : Promise<any>{
        try {
            const payload = { amount, validAfter, validUntil, initiatorAddress, subscriberAddress, paymentInterval, paymentLimit , dappId};
            const headers = {
                "x-api-key": apiKey,
